...
export default function Home() {
  return <><SiteHeader /><main>
    <section className="wix-hero"><div className="wix-hero-inner"><h1>Illuminating the<br />Word of God</h1><p>Deep exegesis and illuminating media designed to restore your connection to the truth of God&apos;s Word.</p><div className="hero-buttons"><Link className="wix-button" href={sitePath('/blog')}>Explore Articles</Link><Link className="story-button" href={sitePath('/about')}>Our Story</Link></div></div></section>
